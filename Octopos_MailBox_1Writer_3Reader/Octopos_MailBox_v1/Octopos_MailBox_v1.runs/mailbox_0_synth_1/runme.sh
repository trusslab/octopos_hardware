...
HD_PWD='/home/mohammad/Octopos/from_zephyr/octopos_hardware/Octopos_MailBox_1Writer_3Reader/Octopos_MailBox_v1/Octopos_MailBox_v1.runs/mailbox_0_synth_1'
cd "$HD_PWD"
