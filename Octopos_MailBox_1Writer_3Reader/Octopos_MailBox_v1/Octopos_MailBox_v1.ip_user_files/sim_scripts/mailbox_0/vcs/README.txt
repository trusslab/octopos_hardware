...
#
# Generated by export_simulation on Thu Dec 17 15:21:31 PST 2020
#
################################################################################
...
'-reset_run' switch to the './mailbox_0.sh' script.

./mailbox_0.sh -reset_run
...
./mailbox_0.sh -noclean_files

For more information on the script, please type './mailbox_0.sh -help'.
