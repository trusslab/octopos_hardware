...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_S_ctrl_AXI_DATA_WIDTH" -parent ${Page_0}


}

proc update_PARAM_VALUE.CLK_ATTR { PARAM_VALUE.CLK_ATTR } {
	# Procedure called to update CLK_ATTR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.CLK_ATTR { PARAM_VALUE.CLK_ATTR } {
	# Procedure called to validate CLK_ATTR
	return true
}
...
proc update_MODELPARAM_VALUE.CLK_ATTR { MODELPARAM_VALUE.CLK_ATTR PARAM_VALUE.CLK_ATTR } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.CLK_ATTR}] ${MODELPARAM_VALUE.CLK_ATTR}
}
