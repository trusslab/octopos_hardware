...
module Octopos_MailBox_Main_Logic (
	...
	// ctrl interface 3
		input  S_WRITE_REQ_3,
		input  [31:0] S_WRITE_STATE_VALUE_3,
		input  S_INTERRUPT_CLEAR_3,
		output [31:0] S_READ_STATE_VALUE_3,
		output S_INTERRUPT_3,
	// ctrl interface 4
		input  S_WRITE_REQ_4,
		input  [31:0] S_WRITE_STATE_VALUE_4,
		input  S_INTERRUPT_CLEAR_4,
		output [31:0] S_READ_STATE_VALUE_4,
		output S_INTERRUPT_4,
	// ctrl interface 5
		input  S_WRITE_REQ_5,
		input  [31:0] S_WRITE_STATE_VALUE_5,
		input  S_INTERRUPT_CLEAR_5,
		output [31:0] S_READ_STATE_VALUE_5,
		output S_INTERRUPT_5,
	// ctrl interface 6
		input  S_WRITE_REQ_6,
		input  [31:0] S_WRITE_STATE_VALUE_6,
		input  S_INTERRUPT_CLEAR_6,
		output [31:0] S_READ_STATE_VALUE_6,
		output S_INTERRUPT_6,
...
begin
	case(owner_id)
		...
		`ID3: begin
			write_state_value = S_WRITE_STATE_VALUE_3;
			write_req = S_WRITE_REQ_3;
		end
		`ID4: begin
			write_state_value = S_WRITE_STATE_VALUE_4;
			write_req = S_WRITE_REQ_4;
		end
		`ID5: begin
			write_state_value = S_WRITE_STATE_VALUE_5;
			write_req = S_WRITE_REQ_5;
		end
		`ID6: begin
			write_state_value = S_WRITE_STATE_VALUE_6;
			write_req = S_WRITE_REQ_6;
		end
		default: begin
...
//Generate a siganl for expired or yield
always @(*)
begin
...
//Control Interface 3
Octopos_MailBox_Ctrl_Interface_Manager  Interface_3(
	.S_CLK(S_CLK),
	.S_ARESETN(S_ARESETN),
	.S_SYSTEM_STATE_REG(S_SYSTEM_STATE_REG),
	.S_INTERRUPT_CLEAR(S_INTERRUPT_CLEAR_3),
	.S_READ_STATE_VALUE(S_READ_STATE_VALUE_3),
	.S_INTERRUPT(S_INTERRUPT_3),
	.S_ID({1'b0,`ID3})
);
//Control Interface 4
Octopos_MailBox_Ctrl_Interface_Manager  Interface_4(
	.S_CLK(S_CLK),
	.S_ARESETN(S_ARESETN),
	.S_SYSTEM_STATE_REG(S_SYSTEM_STATE_REG),
	.S_INTERRUPT_CLEAR(S_INTERRUPT_CLEAR_4),
	.S_READ_STATE_VALUE(S_READ_STATE_VALUE_4),
	.S_INTERRUPT(S_INTERRUPT_4),
	.S_ID({1'b0,`ID4})
);
//Control Interface 5
Octopos_MailBox_Ctrl_Interface_Manager  Interface_5(
	.S_CLK(S_CLK),
	.S_ARESETN(S_ARESETN),
	.S_SYSTEM_STATE_REG(S_SYSTEM_STATE_REG),
	.S_INTERRUPT_CLEAR(S_INTERRUPT_CLEAR_5),
	.S_READ_STATE_VALUE(S_READ_STATE_VALUE_5),
	.S_INTERRUPT(S_INTERRUPT_5),
	.S_ID({1'b0,`ID5})
);
//Control Interface 6
Octopos_MailBox_Ctrl_Interface_Manager  Interface_6(
	.S_CLK(S_CLK),
	.S_ARESETN(S_ARESETN),
	.S_SYSTEM_STATE_REG(S_SYSTEM_STATE_REG),
	.S_INTERRUPT_CLEAR(S_INTERRUPT_CLEAR_6),
	.S_READ_STATE_VALUE(S_READ_STATE_VALUE_6),
	.S_INTERRUPT(S_INTERRUPT_6),
	.S_ID({1'b0,`ID6})
);
