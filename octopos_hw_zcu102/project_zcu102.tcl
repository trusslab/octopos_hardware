...
"
  ...
  connect_bd_net [get_bd_pins OS_subsys/mailbox0_busy_n4] [get_bd_pins enclave0_subsys/busy0]
  connect_bd_net [get_bd_pins OS_subsys/domain1_busy1] [get_bd_pins enclave0_subsys/busy1]
  ...
  connect_bd_net [get_bd_pins OS_subsys/mailbox0_busy_n5] [get_bd_pins enclave1_subsys/busy0]
  connect_bd_net [get_bd_pins OS_subsys/domain1_busy] [get_bd_pins enclave1_subsys/busy1]
  ...
  connect_bd_net [get_bd_pins OS_subsys/domain3_busy] [get_bd_pins ethernet_subsystem/Res]
  connect_bd_net [get_bd_pins OS_subsys/domain3_busy1] [get_bd_pins ethernet_subsystem/Res1]
  connect_bd_net [get_bd_pins OS_subsys/mailbox0_busy_n] [get_bd_pins ethernet_subsystem/busy0]
  connect_bd_net [get_bd_pins OS_subsys/mailbox1_busy_n] [get_bd_pins ethernet_subsystem/busy1]
  connect_bd_net [get_bd_pins OS_subsys/mailbox2_busy_n] [get_bd_pins ethernet_subsystem/busy2]
  connect_bd_net [get_bd_pins OS_subsys/mailbox3_busy_n] [get_bd_pins ethernet_subsystem/busy3]
  ...
  connect_bd_net [get_bd_pins OS_subsys/in_reset_n] [get_bd_pins ps_subsystem/pl_resetn0]
  ...
  connect_bd_net [get_bd_pins OS_subsys/mailbox0_busy_n2] [get_bd_pins secure_serial_in/busy0]
  connect_bd_net [get_bd_pins OS_subsys/domain5_busy] [get_bd_pins secure_serial_in/busy1]
  connect_bd_net [get_bd_pins OS_subsys/domain5_busy1] [get_bd_pins secure_serial_in/busy2]
  connect_bd_net [get_bd_pins OS_subsys/mailbox0_busy_n3] [get_bd_pins secure_serial_out/busy0]
  connect_bd_net [get_bd_pins OS_subsys/domain4_busy] [get_bd_pins secure_serial_out/busy1]
  connect_bd_net [get_bd_pins OS_subsys/domain4_busy1] [get_bd_pins secure_serial_out/busy2]
  ...
  connect_bd_net [get_bd_pins OS_subsys/domain2_busy3] [get_bd_pins storage_subsystem/Res]
  connect_bd_net [get_bd_pins OS_subsys/domain2_busy4] [get_bd_pins storage_subsystem/Res1]
  connect_bd_net [get_bd_pins OS_subsys/mailbox0_busy_n1] [get_bd_pins storage_subsystem/busy0]
  connect_bd_net [get_bd_pins OS_subsys/mailbox1_busy_n1] [get_bd_pins storage_subsystem/busy1]
  connect_bd_net [get_bd_pins OS_subsys/mailbox2_busy_n1] [get_bd_pins storage_subsystem/busy2]
  connect_bd_net [get_bd_pins OS_subsys/mailbox3_busy_n1] [get_bd_pins storage_subsystem/busy3]
  connect_bd_net [get_bd_pins OS_subsys/domain2_busy2] [get_bd_pins storage_subsystem/busy4]
  connect_bd_net [get_bd_pins OS_subsys/domain2_busy1] [get_bd_pins storage_subsystem/busy5]
  connect_bd_net [get_bd_pins OS_subsys/domain2_busy] [get_bd_pins storage_subsystem/busy6]
